...
find_letters(<<L:8, Next/binary>>, <<Text:8, NextText/binary>>, TextIndex)
    when L == Text ->
...
find_end(_, <<>>, _, MaxIndex) ->
    MaxIndex.

find_first(Letter, <<L:8, Next/binary>>, Index) when Letter == L ->
    {Index, Next, Index + 1};
